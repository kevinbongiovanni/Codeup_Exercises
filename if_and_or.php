...
if ($x > 0 || $x < 10) {
	echo "{$x} is greater than 0) || {$x} is less than 10" . PHP_EOL;
	} 
if ($y > 0 || $y < 10)	{
	echo "{$y} is greater than 0 || {$y} is less than 10" . PHP_EOL;
}
if ($z > 0 || $z < 10) {
	echo "{$z} is greater than 0 || {$z} is less than 10" . PHP_EOL;
}
